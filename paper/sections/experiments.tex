...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/generated/glossary_least_frequent.pdf}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/generated/glossary_intermediate.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{figures/generated/discrepancy.pdf}
...
Selected clusters are visualised using t-SNE projections of their HOG descriptors in the supplementary materials.
...
% To include specific t-SNE plots:
% \begin{figure}[t]
%     \centering
%     \includegraphics[width=0.8\linewidth]{figures/generated/tsne_clusters/tsne_cluster_<ID>_<tag>.pdf}
%     \caption{t-SNE layout of cluster <ID>.}
% \end{figure}

% ── Alignment visualization ──
\begin{figure*}[t]
    \centering
    \includegraphics[width=\textwidth]{figures/generated/alignment_viz.pdf}
