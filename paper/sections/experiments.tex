...
% ===========
% TODO:
% - fig. 13: Add two other pages - least present characters and clusters of 2
% - Add figure for when there is GT vs no GT
% The work is not yet complete because the OCR is making coherent errors and that characters can be ill-exctracted and ill-clustered in a coherent way (undetectable)
% -> Show the examples of such cases
% -> Examples of errors | Discrepancy statistics
% -> Upload transcription vs OCR
% 

%
% REGISTER ON MISCROSOFT MCT
%
