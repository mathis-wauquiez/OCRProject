...
Section~\ref{sec:experiments} details the evaluation protocol and ablation studies.
...
The method combines CRAFT text detection, affine scale-space vectorisation, \textit{a contrario} statistical matching, Leiden community detection, and a two-stage refinement pipeline (Hausdorff splitting followed by OCR-guided PCA rematching).
...
Future work will focus on cross-corpus generalisation and on extending the feature representation to learned embeddings and deformation-invariant descriptors.
