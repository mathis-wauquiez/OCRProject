...
Our pipeline processes scanned historical document images to extract, describe, and cluster individual character glyphs through four stages: (1)~character extraction, (2)~preprocessing including vectorisation, OCR, and feature computation, (3)~\textit{a contrario} matching and graph-based clustering, and (4)~post-clustering refinement.
...
Binary patches are cleaned by morphological filtering (removing small holes and noise specks), then converted to SVG via Potrace-based vectorisation.
